...
2. **Dark and light mode**: toggle both with the header theme button; every page uses `data-theme` on `<html>` via `/assets/theme.js`. Text stays readable, illustrations stay cohesive.
